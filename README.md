...
## Why was it made
It was built for practicing python, Pandas, csv transformation, json writing, and basic business analytics concepts, such as identifying top customers, products and categories.
## How to run it
```bash
pip install pandas
python main.py
```
> Linux and MacOS users may need to use 'python3' instead of 'python'
